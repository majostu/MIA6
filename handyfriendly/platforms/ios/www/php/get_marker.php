...
if (isset($_GET['get_toilets']) && $_GET['get_toilets'] == 'all') { 
	$data = $toilets->all();
	echo json_encode($data, JSON_NUMERIC_CHECK);
} else if (isset($_GET['delete_id'])) { 
	$toilets->id = $_GET['delete_id'];		
	$toilets->Delete();
	echo json_encode($toilets, JSON_NUMERIC_CHECK);
	
	$comments->toilet_id = $_GET['delete_id'];		
	$comments->Delete();
